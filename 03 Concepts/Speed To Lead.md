...
> Twenty seconds from form submission to ringing phone. Everything downstream is easier when you're first.

## Definition

The gap between a lead arriving and you calling them. Measured in seconds, not hours.
...
- Leads sit in the CRM for hours before anyone calls
- You batch your callbacks
- You find out about new leads by checking, rather than being told

## Common Mistakes

- Emailing or texting first when the lead gave you a phone number — see [[Sales Happen On The Phone]]
- Having no notification when a lead arrives. This is what the lead-form zap is for —
  see [[Zapier]].
