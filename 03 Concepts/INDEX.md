...
- [[AI Chatbots For Sales]] — Technically buildable, but humans always outperform on the sales call — the only sound use for AI here is after-hours, non-sales support.  (Developing)
- [[Airbnb Clients]] — High pressure, thin margin, and one sick cleaner turns into a one-star review and a chargeback.
- [[Building Connection]] — The first two minutes of a call are for a real question about them, not silence while you pull up your screen.  (Developing)
...
- [[Close Rate By Channel]] — A lead is not a lead — where it came from predicts whether it closes, and "healthy" means profitable, not a fixed percentage.  (Developing)
...
- [[Ideal Customer Profile]] — Start with pet owners, busy professionals, and retired/elderly clients — then ask on every call why they're actually looking, and tailor your words to that.  (Developing)
- [[Importing Contacts Into Harvest CRM]] — Sort contacts by booking history before you import — dumping everyone into one workflow blasts recurring clients with promos and buries leads worth following up.  (Developing)
...
- [[Owner Learns Marketing First]] — Don't outsource marketing before you understand it yourself — you can pay someone to execute once you already know what good looks like.  (Developing)
...
- [[Sell The Result Not The Service]] — Nobody buys "we mop floors and clean baseboards" — they buy relief, pride, and a home they're not embarrassed by.  (Developing)
...
- [[Website Strategy]] — Get a simple website on day one — it builds trust and supports paid search, but it does not generate leads by itself.  (Developing)
...
- [[Backup Cleaner]] — Even with no growth plans, one cleaner leaving should not be able to take you down.
...
- [[Cleaner Job Notes]] — Structure every client's job notes under three fixed headers — preferred cleaner, clean exclusions, unique notes — instead of a free-form scribble, and access details (gate codes, apartment routes) belong there from the very first booking.
- [[Cleaner Pay Structure]] — Pay per job, not per hour — a percentage of that job's revenue, with tips passed straight through and no guaranteed minimum.  (**contested**)
- [[Cleaner-Caused Damage]] — Never take blame before you've actually investigated — but still make the client whole, because the subcontractor's insurance and agreement determine who *pays*, not whether the client gets taken care of.
...
- [[Harvest CRM]] — The CRM (lead follow-up, hiring pipeline, workflow automation) — not [[BookingKoala]], which is the booking calendar.  (Developing)
- [[Hire Slow Fire Fast]] — Take the time to really qualify who you bring on — then the moment someone's proven not to be a fit, move on quickly instead of holding on for emotional reasons.
- [[Hiring Channels]] — Boosted Indeed post, Google Maps cold calls, and a local Facebook group post — then interview in bulk.
- [[Hiring a Cleaner SOP]] — Qualify, interview on a rubric, paper the hire before assigning work, then pair the first job with an experienced cleaner and evaluate before going solo.
...
- [[Labor Before Leads]] — When both are broken, fix the slower one first — and hiring is always the slower one.
- [[Labor Engine]] — The system that keeps demand and capacity to fulfill it in balance — finding, onboarding, paying, and retaining enough dependable cleaners that a booking is never stronger than the team's ability to actually show up and do the work.  (Developing)
- [[Scheduling Cleans]] — Two cleans per cleaner per day, with arrival windows — not four.  (Developing)
- [[Should Clients Have A Cleaner's Number]] — No — the business stays the single point of contact between client and cleaner in nearly every case, because direct contact opens the door to poaching, not because it's a communication nicety.
...
- [[Subcontracting Add-On Services]] — When a client wants something you don't offer, subcontract it and stay the point of contact — or buy the equipment once demand is proven.  (Developing)
- [[Subcontractor Vs W-2]] — Subcontract until you've got money saved — W-2 is a real cost jump, not a formality swap.  (Developing, **contested**)
- [[Testing A New Cleaner]] — Partner them with your best cleaner for two or three cleans, then ask your best cleaner.
- [[Three-Strike System]] — Log every client complaint against a cleaner as a strike — three, and they're off the team — but stay flexible with cleaners who've earned trust over time.
...
- [[Systems Cost-Benefit Analysis]] — There's no universal price ceiling for a system — weigh what it costs against what it returns (money, time, or reduced burnout), and let that number decide, not a gut feel about the sticker price.
