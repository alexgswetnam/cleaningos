...
|---|---|---|---|---|
| **Leads** | Pick one channel + a simple sales script for consistent bookings | Make the channel reliable — track cost per booking, tighten conversion, learn objection handling | Add a second channel + capacity-based marketing to turn volume up/down | Delegate marketing with reporting; protect lead quality and brand reputation |
| **Labor** | Get one reliable helper, or clean it yourself | Onboarding checklist + an onboarding packet (see [[Cleaner Handbook]]) so reliability improves | Backup coverage + team leads so growth doesn't collapse when someone leaves | Reduce risk by onboarding new cleaners monthly and running a quality-testing phase |
