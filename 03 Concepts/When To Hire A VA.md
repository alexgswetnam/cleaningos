...
> Hire when you're losing money by not having one — which is earlier than it feels.

## Definition

The timing decision for a virtual assistant, and the economics behind it.

## Why It Matters

The cost feels like the question. It isn't. **The missed calls are the question.**

> "You missed a $400 call at the movies? A $200/week VA would have caught that."

One missed booking can exceed a fortnight of VA cost.

## The Three Cases

**1. You work a 9-to-5 and can't answer calls.** Hire immediately. Every call during your
...
wasn't the problem. The missing VA to answer the phone was. See [[Channel Prioritization]]
for the full LSA text-vs-phone breakdown.

**5. It's starting to feel like a second job.** Jack, ~$10K/month, 8 hours of coordination
work daily on top of everything else — named on the 2026-02-24 call as the signal it's
time, distinct from the hard "can't answer calls" cases above. The feeling itself is the
data point.

**The counter-example — you might genuinely not need one.** A member in Canada runs
$100K/month with no VA, because the whole model is instant quotes through the website —
no calls to miss in the first place. This isn't a case *for* delaying a VA everywhere;
it's evidence that case 3 above (maximum control, can genuinely do it all) is a real,
working model when the sales motion doesn't depend on someone answering a phone.

**Build with handoff in mind from day one.** Alex and Elijah built SOPs, the CRM, and
Notion from the start assuming someone else would eventually operate them — not
retrofitted after hiring a VA. Your first VA won't be perfect regardless; expect kinks.
That's the argument for starting earlier rather than waiting for a "clean" moment to hand
off. See [[SOPs]].

**Where to actually find one:** onlinejobs.ph, Fiverr (message candidates directly),
Facebook groups (the BookingKoala group specifically), or Alex's train-and-place model —
he trains a VA on his own systems and SOPs (40+ of them), then places that VA with a
member. The details, as of 2026-04-27: the VA belongs to the member, not to Alex's team —
this is explicitly a "trained VA" placement, not a "managed VA" service. It requires a
12-month Skool commitment at a discounted rate, but if the placed VA doesn't work out,
there's no further obligation. Results are mixed but real: Rick is happy with his; Jack
was considering a replacement as of the same call.
...
| Arrangement | Shape |
|---|---|
| **Full-time** | 9 AM – 6 PM your time, on-call 7–9 AM and after 6 PM for emergencies |
| **Part-time** | 3 hours in the busiest window — often morning |
| **Evening** | 4–7 PM, useful when your kids get home |

> If a part-time VA closes even one deal you'd have missed, they've more than paid for
> themselves.

## Female VAs Close Better

Alex's numbers in the cleaning industry: **female VA 45–60% close rate, male VA 30%.**
His read: women want to talk to women.

## Symptoms

- Calls going to voicemail during your day job
- You're doing coordination work at 10 PM
- You know you're missing bookings but can't say how many

## Common Mistakes

- Assuming you can't afford one while losing sales for lack of one
...
- [ ] Estimate calls missed per week and their value
- [ ] Compare against $200/week
...
**Alex** — VA handles everything; Logistics and Leadership both at Harvest, owners working
~1 hour/week.

**Jack** — onboarding Eva at the time of the March calls. See [[Managing A VA]].
...
**Q:** What do I give them first?
**A:** The daily checklist from [[SOPs]]. If you can't hand over a checklist, you're not
ready to hand over the work.
